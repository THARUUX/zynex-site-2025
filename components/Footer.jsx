...
export default function Footer() {
  return (
    <div className='flex flex-col max-h-[] justify-center pb-15 items-center border-t border-[#AE00FF] rounded-t-[50px] relative overflow-hidden px-2'>
        ...
        <div className='w-full flex flex-col  top-0 left-0'>
            ...
            <div className='flex flex-col md:flex-row w-full justify-around text-sm text-white/70 md:text-base orbitron-400 px-10 gap-5'>
            ...
            <div className='w-full flex text-center justify-center px-10 text-xs md:text-sm py-10 opacity-50'>Designed & Developed by ZYNEX DEVELOPMENTS | Copyrights Reserved | 2025</div>
        </div>
    </div>
  )
}
