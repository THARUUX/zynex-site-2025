            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    >
                        ...
                        <motion.p className="text-sm text-white/80 mt-8">
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="h-7 w-7 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center group/button border border-white/20 hover:bg-white/20 transition-colors"
                        >
